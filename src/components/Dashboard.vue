  ...
  <div class="dashboard">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav ml-auto">
							<li class="nav-item">
                <router-link to="/dapp"><a class="primary-btn">Enter</a></router-link>
							</li>
              <li class="nav-item" >
                <img 
                  src="https://res.cloudinary.com/mmitrasish/image/upload/v1553985742/eth_online.svg" 
                  alt="ethereum-icon"
                  height="40px"
                  width="25px"
	...
	<section class="home_banner_area">
		<div class="banner_inner">
            ...
            <h2>CryptoConstellation</h2>
						<p style="font-size: 20px" class="p-first">It's your Universe!</p><img src="https://res.cloudinary.com/mmitrasish/image/upload/v1554043886/logo.png" alt="logo" class="logo-middle" height="200px" width="200px" /><p class="p-second" style="font-size: 20px"><span style="font-size: 30px">Deal</span> with it.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row align-items-end justify-content-left">
				<div class="col-lg-12">
					<div class="main_title">
						<h1>Grab the Universe in your Grip in Blockchain</h1>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<p style="text-align:left; font-size:16px; font-family:Roboto;">Buy constellations as Smart Contracts using Blockchain Technology and take over the universe. 
            <br><br>Be the God of the universe and own constellations such as Orion, Gemini, Taurus, etc as Smart Contract powered by IPFS (InterPlanetary File System) Technology on the ethereum blockchain. 
            <br><br>CryptoConstellation is an interactive game that let anyone buy and own Contellations as Smart Contract powered by IPFS Technology an the Ethereum Blockchain. As soon as you aquire a constellation you take ownership of that Asterism and it can automatically increases in price.
            <br><br><span style="color:#FFBF00">Be Alert!</span> If anyone else want to grab your Constellation, they can by paying upto double the price that you paid. You will then loose the Ownership of that constellation, but you will recieve upto double the amount in ETH automatically transfered back to your crypto wallet. 
          </p>
				</div>
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<img src="https://res.cloudinary.com/mmitrasish/image/upload/v1554037397/constellation-image-1.jpg" alt="constellation" height="400px" width="400px" style="border-radius:300rem"/>
				</div>
				<!-- single-feature -->
			</div>
		</div>
  ...
  <section class="feature-area section_gap_top">
		<div class="container">
			<div class="row align-items-end justify-content-left">
				<div class="col-lg-12">
					<div class="main_title">
						<h1>Player Friendly Value Increment Model</h1>
						<span class="title-widget-bg"></span>
					</div>
				</div>
			</div>
			<div class="row">
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<img src="https://res.cloudinary.com/mmitrasish/image/upload/v1554043205/Layer_1.png" alt="constellation" height="350px" width="350px"/>
				</div>
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<p style="text-align:left; font-size:16px; font-family:Roboto; margin-top:40px;">CryptoConstellations is a player friendly value increment model with minimum commisions. Compared to other collectible games that charges massive commisions on each purchase, CryptoConstellation value both the players and the game. If you don't thust us check it out for you by reading our Smart Contract and comparing it with others.
            <br><br>In CryptoConstellations, you can take control of any available constellation of the universe in our marketplace. Any other can also purchase and take control over your constellation as long as they pay upto double the amount of what you paid to conquer the constellation in the first place. 
            <br><br>The new price including of profit is then transferred back to previous owner of the constellation automatically.
          </p>
        </div>
				<!-- single-feature -->
			</div>
  ...
  <section class="feature-area section_gap_top">
		<div class="container">
			<div class="row align-items-end justify-content-left">
				<div class="col-lg-12">
					<div class="main_title">
						<h1>First Fully Decentraized Crypto Collectibles</h1>
						<span class="title-widget-bg"></span>
					</div>
				</div>
			</div>
			<div class="row">
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<p style="text-align:left; font-size:20px; font-family:Roboto; margin-top:80px;">As we have used the IPFS Technology in this game, when you aquire a constellation you will be the sole owner of that constellation and your constellation will be immutable forever. (Untill someone buys that constellation from you.)
          </p>
				</div>
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<img src="https://res.cloudinary.com/mmitrasish/image/upload/v1554048696/cards.png" alt="constellation" height="400px" width="400px"/>
        </div>
				<!-- single-feature -->
			</div>
		</div>
  ...
  <section class="feature-area section_gap_top">
		<div class="container">
			<div class="row align-items-end justify-content-left">
				<div class="col-lg-12">
					<div class="main_title">
						<h1>Universe Domination on the Blockchain</h1>
						<span class="title-widget-bg"></span>
					</div>
				</div>
			</div>
			<div class="row">
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<img src="https://res.cloudinary.com/mmitrasish/image/upload/v1554049408/Untitled-2.png" alt="constellation" height="350px" width="450px"/>
				</div>
				<!-- single-feature -->
				<div class="col-lg-6 col-md-6">
					<p style="text-align:left; font-size:16px; font-family:Roboto; margin-top:40px;">CryptoConstellation run on Ethereum Blockchain powered by IPFS Technology. Each constellation collectible tokens represented by card image stored in IPFS and linked to one single Smart Contract Token on the game's blockchain.
            <br><br>To aquire (purchase) a Constellation Smart Contract: Send Ether to the Contract using Metamask. As soon as your transaction has been confirmed, you (and only you) have Ownership of that Constelation.
            <br><br>The Leaderboard will show off your consquest to the rest of the world, and the colour of your contellation card will be based on last characters of your Wallet Address. 
          </p>
        </div>
				<!-- single-feature -->
			</div>
	...
	<footer class="footer-area">
		<div class="footer_top section_gap_top">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget" style="text-align:left">
							<h5 class="footer_title">About Crypto Constellation</h5>
					...
					<div class="col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget" style="text-align:left;margin-left: 10px;">
          ...
          <div class="col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget" style="text-align:left;margin-left: 10px;">
							<h5 class="footer_title">The Game</h5>
							<div class="row" style="margin:0px">
								<div>
									<ul class="list">
										<li><a href="#">Marketplace</a></li>
										<li><a href="#">My Constellation</a></li>
										<li><a href="#">Laderboard</a></li>
...
.gradient-bg2, .single-package:hover .date {
...
.gradient-color, .single-footer-widget .bb-btn {
  background: -webkit-linear-gradient(90deg, #ff2f8b 0%, #9035f9 100%);
  background: -moz-linear-gradient(90deg, #ff2f8b 0%, #9035f9 100%);
  background: -ms-linear-gradient(90deg, #ff2f8b 0%, #9035f9 100%);
  background: -o-linear-gradient(90deg, #ff2f8b 0%, #9035f9 100%);
...
============================================================================================ */
.home_banner_area {
  background: url(https://res.cloudinary.com/mmitrasish/image/upload/v1553933709/background.png) no-repeat center center;
  ...
  .home_banner_area .banner_inner .banner_content {
    ...
    .home_banner_area .banner_inner .banner_content p {
      ...
      font-weight: 800;
      text-transform: uppercase; }
      .home_banner_area .banner_inner .banner_content .p-first, .p-second, .logo-middle {
        display: inline;
      }

      .home_banner_area .banner_inner .banner_content .p-second {
        float: right;
        padding-top: 20px;
      }

      .home_banner_area .banner_inner .banner_content .p-first {
        float: left;
        padding-top: 23px;
      }

      .home_banner_area .banner_inner .banner_content .logo-middle {
        float: center;
      }
...
.single-blog {
  ...
  .single-blog .blog-details {
    ...
    .single-blog .blog-details p {
      margin-bottom: 0; }
    .single-blog .blog-details .blog-meta p {
      font-size: 13px;
      margin-right: 20px; }
      .single-blog .blog-details .blog-meta p a {
        color: #777777; }
...
.trip-form-section {
  ...
  .trip-form-section .primary-btn {
    ...
    -o-transition: all 0.3s ease 0s;
    transition: all 0.3s ease 0s; }
    .trip-form-section .primary-btn:hover {
      background: #777777; }
  .trip-form-section .form-select .nice-select {
    ...
    height: 40px;
    color: #ffffff; }
    .trip-form-section .form-select .nice-select .list .option {
      color: #000000; }
      .trip-form-section .form-select .nice-select .list .option.selected {
        color: #ff2f8b; }
      .trip-form-section .form-select .nice-select .list .option:hover {
        color: #ff2f8b; }

/* End Trip Form Area css
============================================================================================ */
/*---------------------------------------------------- */
/*----------------------------------------------------*/
